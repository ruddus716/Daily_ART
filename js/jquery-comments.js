        ...
        uploadAttachments: function (files, commentingField) {
            ...
            if (fileCount) {
                ...
                $(files).each(function (index, file) {
                    ...
                    commentJSON.fileURL = 'http://35.206.125.75/OPENSW_ART/uploads/' + file.name;
...
function review_insert(data) {
    ...
    var profileImg = data.profilePictureURL;
    var createdByCurrentUser = data.createdByCurrentUser;
    var upvote = data.upvoteCount;
    var userHasUpvoted = data.userHasUpvoted;
    $.ajax(
        {
            type: 'POST',
