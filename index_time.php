...
<body id="page-top">
  ...
  <body>
    ...
    <ul class="tab">
      <li class="current" data-tab="tab1"><a href="#">시대별</a></li>
      <li data-tab="tab2"><a href="index_arty.php">작가별</a></li>
    </ul>
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            while( $row = mysqli_fetch_assoc( $resource ) ) {
              ...
              print "<td><a href=view_time.php>$row[title]</td>";
    ...
    <div class="container">
      <form class="navbar-form navbar-right" method=POST action=write_time.php>
